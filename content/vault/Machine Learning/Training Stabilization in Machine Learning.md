...
1. [[#1. Why Training Goes Wrong]]
2. [[#2. Regularization]]
    - 2.1 L2 (Weight Decay)
    - 2.2 L1 (Lasso)
    - 2.3 Elastic Net
    - 2.4 Max-Norm Constraint
3. [[#3. Dropout and Its Variants]]
    - 3.1 Standard Dropout
    - 3.2 DropConnect
    - 3.3 Spatial Dropout (2D)
...
8. [Data-Level Stabilization](#8-data-level-stabilization)
...
9. [Loss Function Design](#9-loss-function-design)
    ...
    - 9.2 Focal Loss
    - 9.3 Huber Loss
10. [Early Stopping](#10-early-stopping)
11. [Ensemble Methods as Regularizers](#11-ensemble-methods-as-regularizers)
12. [Modern / Advanced Techniques](#12-modern--advanced-techniques)
    - 12.1 Stochastic Depth
    - 12.2 LayerScale
    - 12.3 Exponential Moving Average (EMA)
    - 12.4 Sharpness-Aware Minimization (SAM)
    - 12.5 Gradient Noise Injection
13. [Diagnosing Training Instability](#13-diagnosing-training-instability)
